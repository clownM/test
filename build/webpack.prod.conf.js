...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      // necessary to consistently work with multiple chunks via CommonsChunkPlugin
      chunksSortMode: 'dependency',
      chunks:['manifest','vendor','mall']
    }),
    new HtmlWebpackPlugin({
      filename: config.build.order,
      template: 'order.html',
      inject: true,
      minify: {
        removeComments: true,
    ...
    new HtmlWebpackPlugin({
      ...
      // necessary to consistently work with multiple chunks via CommonsChunkPlugin
      chunksSortMode: 'dependency',
      chunks:['manifest','vendor','address']
    }),
    new HtmlWebpackPlugin({
      filename: config.build.addAddress,
      ...
      // necessary to consistently work with multiple chunks via CommonsChunkPlugin
      chunksSortMode: 'dependency',
      chunks:['manifest','vendor','addAddress']
    }),
